...
- 👀 I’m interested in Back-end Web Development (Python/Django/DRF), Automation (Selenium), Code Testing, Front-end Web development (ReactJS), RDBMS (SQL/PostgreSQL), Cloud Deployment (AWS), Data Structures, Algorithms, and Clean Code Architectures.
